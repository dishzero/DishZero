...
function Email() {
    ...
    async function getInfo() {
        try {
            const response = await axios.get(`${BACKEND_ADDRESS}/api/cron/email/`, {
    ...
    async function startCronJob() {
        try {
            const response = await axios.post(
                `${BACKEND_ADDRESS}/api/cron/email/start`,
                {},
                {
                    headers: headers(sessionToken),
                },
    ...
    async function stopCronJob() {
        try {
            const response = await axios.post(
                `${BACKEND_ADDRESS}/api/cron/email/stop`,
                {},
                {
                    headers: headers(sessionToken),
                },
    ...
    async function saveTemplate() {
        try {
            const response = await axios.post(
                `${BACKEND_ADDRESS}/api/cron/email/template`,
                {
                    template: {
                        senderEmail: sender,
                        subject: subject,
        ...
        try {
            const response = await axios.post(
                `${BACKEND_ADDRESS}/api/cron/email/expression`,
                {
                    days,
                    exprTime,
                },
